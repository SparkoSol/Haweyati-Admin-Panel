  ...
  <v-container>
    <v-row>
      ...
      <v-col cols="12" md="8" sm="8">
        <v-card-title>Building Material Type</v-card-title>
      </v-col>
      <v-col
    ...
    <div
      v-if="buildingMaterialSubs !== null || buildingMaterialSubs.length >= 0"
      class="my-row"
    >
      <div
        v-for="(buildingMaterialSub, i) of buildingMaterialSubs"
        :key="i"
    ...
    <v-container
      v-if="
        (buildingMaterialSubs === null || buildingMaterialSubs.length <= 0) &&
          !loading
      "
